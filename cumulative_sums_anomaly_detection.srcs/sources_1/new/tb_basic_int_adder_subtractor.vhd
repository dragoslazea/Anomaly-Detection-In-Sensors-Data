...
entity tb_basic_int_adder_subtractor is
end tb_basic_int_adder_subtractor;

architecture Behavioral of tb_basic_int_adder_subtractor is
...
signal f1_in_data, f1_out_data, f2_in_data, f2_out_data, f3_in_data, f3_out_data : STD_LOGIC_VECTOR (31 downto 0) := (others => '0');
...
begin
    ...
    add_sub : int_adder_subtractor port map (
        aclk => clk,
