...
entity basys3_int_cusum_anomaly_detector is
...
end basys3_int_cusum_anomaly_detector;

architecture Structural of basys3_int_cusum_anomaly_detector is
...
begin
    ...
    measurements_memory : rom256x32 port map (address => measurement_index, data_out_previous => previous_measurement, data_out_current => current_measurement);
    ...
    int_cusum_anomaly_detector : int_cumulative_sums_detector port map (
        clk => clk,
        rst => nrst,
