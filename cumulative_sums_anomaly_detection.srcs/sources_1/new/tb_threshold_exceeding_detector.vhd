...
entity tb_threshold_exceeding_detector is
end tb_threshold_exceeding_detector;

architecture Behavioral of tb_threshold_exceeding_detector is
...
signal gp_in, gn_in, gp_out, gn_out, th : std_logic_vector(31 downto 0);
...
type test_array is array(0 to 9) of std_logic_vector(31 downto 0);
...
begin
    ...
    gp_in <= test_data(0);
    gn_in <= test_data(2), test_data(3) after 4 * T;  
    th <= test_data(4);  
    
    DUT : threshold_exceeding_detector
        PORT MAP (
            aclk => clk,
            gp_in_valid => '1',
