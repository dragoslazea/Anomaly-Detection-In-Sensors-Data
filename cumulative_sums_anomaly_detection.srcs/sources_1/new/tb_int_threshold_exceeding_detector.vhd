...
entity tb_int_threshold_exceeding_detector is
end tb_int_threshold_exceeding_detector;

architecture Behavioral of tb_int_threshold_exceeding_detector is
...
begin
    ...
    DUT : int_threshold_exceeding_detector
        PORT MAP (
            aclk => clk,
            gp_in_valid => '1',
