...
entity cumulative_sums_detector is
    Port ( 
           -- control inputs
           clk : in STD_LOGIC;
           rst : in STD_LOGIC;
...
end cumulative_sums_detector;

architecture Structural of cumulative_sums_detector is
...
component threshold_exceeding_detector is
...
begin
    ...
    s_t_sub : fp_adder_subtracter port map (
        aclk => clk,
    ...
    gn_s_t_sub : fp_adder_subtracter port map (
        aclk => clk,
    ...
    gp_s_t_add : fp_adder_subtracter port map (
        aclk => clk,
    ...
    gn_drift_sub : fp_adder_subtracter port map (
        aclk => clk,
    ...
    gp_drift_sub : fp_adder_subtracter port map (
        aclk => clk,
    ...
    threshold_exceeding_checker : threshold_exceeding_detector port map (
        aclk => clk,
