...
entity int_cumulative_sums_detector is
    Port ( 
           -- control inputs
           clk : in STD_LOGIC;
           rst : in STD_LOGIC;
...
end int_cumulative_sums_detector;

architecture Structural of int_cumulative_sums_detector is
...
component int_threshold_exceeding_detector is
    Port ( aclk : in STD_LOGIC;
       gp_in_valid : in STD_LOGIC;
       gp_in_ready : out STD_LOGIC;
       gp_in_data : in STD_LOGIC_VECTOR (31 downto 0);
       gn_in_valid : in STD_LOGIC;
       gn_in_ready : out STD_LOGIC;
       gn_in_data : in STD_LOGIC_VECTOR (31 downto 0);
       ...
       gp_out_data : out STD_LOGIC_VECTOR (31 downto 0);
       gn_out_valid : out STD_LOGIC;
       gn_out_ready : in STD_LOGIC;
       gn_out_data : out STD_LOGIC_VECTOR (31 downto 0));
end component;
...
-- data signals
signal current_sensor_measurement, previous_sensor_measurement : STD_LOGIC_VECTOR (31 downto 0);
signal s_t_in, s_t_out, gn_t_1, gp_t_1, gn_s_t_in, gp_s_t_in, gn_s_t_out, gp_s_t_out : STD_LOGIC_VECTOR (31 downto 0);
signal gn_s_t_drift_in, gp_s_t_drift_in, gn_s_t_drift_out, gp_s_t_drift_out : STD_LOGIC_VECTOR (31 downto 0);
signal max_gn_in, max_gp_in, max_gn_out, max_gp_out, gn_t, gp_t, gn_fifo_in, gp_fifo_in : STD_LOGIC_VECTOR (31 downto 0);
signal timestamp_in : STD_LOGIC_VECTOR (31 downto 0) := (others => '0');
signal abnormal_flag : STD_LOGIC;
signal s_t_result : STD_LOGIC_VECTOR (31 downto 0);
...
-- composite ready signals
signal s_t_sub_input_ready, gn_s_t_sub_input_ready : STD_LOGIC;

-- composite valid signals
signal s_t_sub_input_valid, gn_s_t_sub_input_valid : STD_LOGIC;

-- is first control signal
signal is_first : STD_LOGIC := '1';

signal gn_s_t_input, gp_s_t_input : STD_LOGIC_VECTOR (31 downto 0);
signal gn_s_t_input_valid, gp_s_t_input_valid : STD_LOGIC;

begin


    current_sensor_in_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    previous_sensor_in_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    s_t_sub : int_adder_subtractor port map (
        aclk => clk,
    ...
    s_t_result <= s_t_out when is_first = '0' else x"00000000";
    ...
    gp_s_t_input <= x"00000000" when is_first = '1' else gp_t_1;
    gp_s_t_input_valid <= '1' when is_first = '1' else gp_t_1_valid;
    
    gp_s_t_add : int_adder_subtractor port map (
        aclk => clk,
    ...
    gn_s_t_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    gp_s_t_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    gn_drift_sub : int_adder_subtractor port map (
        aclk => clk,
    ...
    gp_drift_sub : int_adder_subtractor port map (
        aclk => clk,
    ...
    gn_s_t_drift_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    gp_s_t_drift_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    max_gn_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    max_gp_fifo_buffer : fifo port map (
        s_axis_aresetn => rst,
        s_axis_aclk => clk,
    ...
    threshold_exceeding_checker : int_threshold_exceeding_detector port map (
        aclk => clk,
    ...
    timestamp_counter : process(clk)
        begin
            if rising_edge(clk) then
                --if current_sensor_measurement_valid = '1' and timestamp_in_ready = '1' then
        ...
        timestamp_data <= timestamp_in;
    
--    timestamp_out_ready <= timestamp_ready and abnormal_flag_valid;
    
--    timestamp_buffer : fifo port map (
--        s_axis_aresetn => rst,
--        s_axis_aclk => clk,
--        s_axis_tvalid => current_sensor_measurement_valid,
--        s_axis_tready => timestamp_in_ready,
--        s_axis_tdata => timestamp_in,
--        m_axis_tvalid => timestamp_valid,
--        m_axis_tready => timestamp_out_ready,
--        m_axis_tdata => timestamp_data,
--        axis_data_count => timestamp_data_count,
--        axis_wr_data_count => timestamp_wr_count,
--        axis_rd_data_count => timestamp_rd_count    
--    );
