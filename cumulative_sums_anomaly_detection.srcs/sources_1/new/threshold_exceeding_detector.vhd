...
entity threshold_exceeding_detector is
...
end threshold_exceeding_detector;

architecture Behavioral of threshold_exceeding_detector is
...
begin
    ...
    comp_p : fp_greater_than
      ...
      gp_out_data <= gp_in_data when abnormal_data_i = '0' else (others => '0');
      ...
      gn_out_data <= gn_in_data when abnormal_data_i = '0' else (others => '0');
