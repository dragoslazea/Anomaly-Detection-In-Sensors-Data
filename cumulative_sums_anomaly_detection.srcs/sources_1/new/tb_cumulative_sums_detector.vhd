...
entity tb_cumulative_sums_detector is
end tb_cumulative_sums_detector;

architecture Behavioral of tb_cumulative_sums_detector is
...
begin
    ...
    process (clk)
        file sensors_data : text open read_mode is "04-12-22_measurements_bin.csv";
    ...
    process 
        file results : text open write_mode is "C:\CTI\Licenta\cumulative_sums_anomaly_detection\04-12-22_results_bin.csv";
