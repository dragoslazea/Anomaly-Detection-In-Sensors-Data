...
entity int_threshold_exceeding_detector is
...
end int_threshold_exceeding_detector;

architecture Behavioral of int_threshold_exceeding_detector is
...
signal gp_out, gn_out : STD_LOGIC_VECTOR (31 downto 0) := (others => '0');
