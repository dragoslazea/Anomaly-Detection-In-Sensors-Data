...
HD_PWD='C:/CTI/Licenta/cumulative_sums_anomaly_detection/cumulative_sums_anomaly_detection.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_cusum_anomaly_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_cusum_anomaly_detector.tcl -notrace
