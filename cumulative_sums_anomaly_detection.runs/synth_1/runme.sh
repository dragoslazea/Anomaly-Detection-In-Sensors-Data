...
HD_PWD='C:/CTI/Licenta/cumulative_sums_anomaly_detection/cumulative_sums_anomaly_detection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_cusum_anomaly_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_cusum_anomaly_detector.tcl
